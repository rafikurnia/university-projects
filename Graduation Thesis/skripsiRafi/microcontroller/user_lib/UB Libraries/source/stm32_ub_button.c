...
BUTTON_t BUTTON[] = {
  ...
  {LOM 		 ,GPIOE,GPIO_Pin_2 ,RCC_AHB1Periph_GPIOE,GPIO_PuPd_NOPULL, Bit_RESET},  // PA0=User-Button auf dem Discovery-Board
  {LOP		 ,GPIOE,GPIO_Pin_4 ,RCC_AHB1Periph_GPIOE,GPIO_PuPd_NOPULL, Bit_RESET},  // PA0=User-Button auf dem Discovery-Board
};
