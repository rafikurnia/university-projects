...
#define portTICK_RATE_S				( ( portTickType ) 1 / configTICK_RATE_HZ )
#define portTICK_RATE_MS			( ( portTickType ) 1000 / configTICK_RATE_HZ )
#define portTICK_RATE_US			( ( portTickType ) 1000000 / configTICK_RATE_HZ )
#define portTICK_RATE_NS			( ( portTickType ) 1000000000 / configTICK_RATE_HZ )
#define portTICK_RATE_PS			( ( portTickType ) 1000000000000 / configTICK_RATE_HZ )
