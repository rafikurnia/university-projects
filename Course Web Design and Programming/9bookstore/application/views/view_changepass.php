        ...
        <div id="registration-form">
            <div class="fieldset">     
                ...
                <?php
                    ...
                    echo form_open('main/changepass_validation');
                    echo"<div class=\"error\">";
                    echo validation_errors();
                    if ($galat == 1) echo "<p>Old Password is Not Correct</p>";
                    echo"</div>";
                    echo"<div class='tengahin'>";
                    echo "<p>Old Password :<br> ";
                    echo form_password('opassword');
                    echo "</p>";
                    ...
                    echo"</div>"; 
                    echo "<p><br>";
                    echo form_submit('signup_submit','Change!');
                    echo "</p>";
